...
aws sqs create-queue --queue-name itmo-544-mp2

aws sns create-topic --name itmo-544-mp2

aws ec2 run-instances --count $1 --image-id ami-4eeb3636 --key-name $2 --security-group-ids $3 --instance-type t2.micro --iam-instance-profile Name=$4 --user-data file://install-app-env.sh
